...
| | |
|:-------------------------:|:-------------------------:|
|![List View](01_list_view.png) *List View: Overview of monitored contracts* | ![Details View](02_details_view.png) *Details View: In-depth contract information*|
|![History View](03_details_view_long_history.png) *Details View: multi-layered transaction history* | ![ABI View](04_ABI_view.png) *ABI when available*|
|![Heatmap](05_heatmap.png) *Heatmap: Visualizing contract interaction patterns* | ![Help](06_help.png) *Comprehensive help*|
|![Command Palette](07_CMD_palette.png) *Easy to use and familiar Ctrl+P command palette* | ![Statistics](08_stats.png) *Statistics*|
...
View the project live here: **ETH Watchtower Live**

*(Note: Once deployed to GitHub Pages, update the link above)*

## 🌐 Hosting on GitHub Pages

This project is pre-configured to work with GitHub Pages.

### Steps to Deploy:

1.  **Push to GitHub:**
    Ensure this directory is initialized as a git repository and pushed to GitHub.
    ```bash
    git init
    git add .
...
3.  **Verify:**
    Wait a minute or two, and your site will be live at the URL provided in the settings!